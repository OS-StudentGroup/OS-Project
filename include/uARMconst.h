...
#define EXC_TLBMOD          PAGEERROR
#define EXC_TLBINVLOAD      SEGERROR
#define EXC_TLBINVSTORE     SEGERROR
#define EXC_ADDRINVLOAD     MEMERROR
#define EXC_ADDRINVSTORE    MEMERROR
...
#define SEGERROR     	3
#define PAGEERROR     	4
#define INVALIDPAGE     5
#define PAGENOTFOUND    6
#define INTEXCEPTION	7
